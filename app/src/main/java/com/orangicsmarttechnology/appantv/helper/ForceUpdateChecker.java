...
public class ForceUpdateChecker {
    ...
    public interface OnUpdateNeededListener {
        void onUpdateNeeded();
        void onUpdateNeededManually(Boolean yesno);
    }
    ...
    public void checkManually() {
        final FirebaseRemoteConfig remoteConfig = FirebaseRemoteConfig.getInstance();
            ...
            if (!TextUtils.equals(currentVersion, appVersion)
                    && onUpdateNeededListener != null) {
                onUpdateNeededListener.onUpdateNeededManually(true);
            }else{
                onUpdateNeededListener.onUpdateNeededManually(false);
            }
    }
    ...
    public static class Builder {
        ...
        public ForceUpdateChecker checkManually() {
            ForceUpdateChecker forceUpdateChecker = build();
            forceUpdateChecker.checkManually();
