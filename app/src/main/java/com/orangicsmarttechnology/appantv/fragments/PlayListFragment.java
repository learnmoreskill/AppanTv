...
public class PlayListFragment extends Fragment {
    ...
    private static String CHANNLE_GET_URL = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=" + Constants.PLAYLIST_ID + "&maxResults=20&key=" + Constants.GOOGLE_YOUTUBE_API_KEY + "";
