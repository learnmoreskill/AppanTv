...
import com.orangicsmarttechnology.appantv.adapters.CommentAdapter;
import com.orangicsmarttechnology.appantv.models.YoutubeCommentModel;
...
//    }
    ...
    private class RequestYoutubeCommentAPI extends AsyncTask<Void, String, String> {
        ...
        protected String doInBackground(Void... params) {
            String VIDEO_COMMENT_URL = "https://www.googleapis.com/youtube/v3/commentThreads?part=snippet&maxResults=100&videoId=" + youtubeDataModel.getVideo_id() + "&key=" + Constants.GOOGLE_YOUTUBE_API_KEY;
